...
class ReunionTest < Minitest::Test
  ...
  def test_it_can_find_amount_owed_to_payees_by_person_and_activity
    @activity_1.add_participant("Maria", 20)
    @activity_1.add_participant("Luther", 40)
    ...
    assert_equal [10], @reunion.amount_owed_per_activity("Maria", @activity_1)
  end
  ...
  def test_it_can_give_a_detailed_breakout
    ...
    assert_equal expected, @reunion.find_participants
  end

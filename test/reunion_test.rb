...
class ReunionTest < Minitest::Test
  ...
  def test_activities_start_as_empty_array
    reunion = Reunion.new("1406 BE")
    assert_equal [], reunion.activities
  end

  def test_it_can_add_and_hold_activities
    reunion = Reunion.new("1406 BE")
  ...
  def test_it_can_track_total_cost_of_all_activities
    reunion = Reunion.new("1406 BE")
    activity_1 = Activity.new("Brunch")
  ...
  def test_it_can_track_breakout
    reunion = Reunion.new("1406 BE")
    activity_1 = Activity.new("Brunch")
    activity_1.add_participant("Maria", 20)
    activity_1.add_participant("Luther", 40)
  ...
  def test_it_returns_detailed_breakout
    ...
    expected = {
  "Maria" => [{ activity: "Brunch", payees: ["Luther"], amount: 10},
    { activity: "Drinks", payees: ["Louis"], amount: -20},
    { activity: "Bowling", payees: ["Louis"], amount: 10},
    { activity: "Jet Skiing", payees: ["Louis", "Nemo"], amount: 10}],
  "Luther" => [
    ...
    { activity: "Jet Skiing", payees: ["Louis", "Nemo"], amount: 10}],
  "Louis" => [
    { activity: "Drinks", payees: ["Maria", "Luther"], amount: 20},
    { activity: "Bowling", payees: ["Maria", "Luther"], amount: -10},
    { activity: "Jet Skiing", payees: ["Maria", "Luther"], amount: -10}],
  "Nemo" => [
    { activity: "Jet Skiing", payees: ["Maria", "Luther"], amount: -10}]
  }

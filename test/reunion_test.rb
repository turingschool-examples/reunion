...
class ReunionTest < Minitest::Test
  ...
  def test_it_can_put_summary_in_print_format
    reunion = Reunion.new("1406 BE")
    activity_1 = Activity.new("Brunch")
    activity_1.add_participant("Maria", 20)
    activity_1.add_participant("Luther", 40)
 ...
 #
 #  def test_it_can_provide_a_detailed_breakout
 #    reunion = Reunion.new("1406 BE")
 #    activity_1 = Activity.new("Brunch")
 #    activity_1.add_participant("Maria", 20)
 #    activity_1.add_participant("Luther", 40)
 ...
 #    anticipated = {"Maria" => [{activity: "Brunch"}]}
 # #    expected =  {
 # #   "Maria" => [
 # #     {
 # #       activity: "Brunch",
 ...
 # #   ]
 # # }
 #    assert_equal anticipated, reunion.add_details(activity_1)
